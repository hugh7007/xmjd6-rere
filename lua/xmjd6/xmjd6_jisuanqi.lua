...
local function calculator_translator(input, seg)
  ...
  -- number_tools owns the compact decimal-to-base syntax (=255>16).
  -- Letting Lua evaluate it as a comparison would add misleading true/false
  -- candidates and the legacy money formatter cannot format booleans.
