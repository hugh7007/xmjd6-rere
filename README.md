**重要时间节点重要内容修改：** 
历经两年的与浮生的功能修改的xmjd在今天正式划上一个句号。并非是因为吵架或什么原因。
目前浮生版本功能已经在纯打字的版本已经更新到了无可再更的地步了，也就是发布后的最后一版。
后续我会单独把这个版本作为分支，并且大概率不会再更新了。
也是给纯喜欢打字的人使用。

我的喜好更偏向娱乐性质，后续主要的这个，我会放仰望版本的更新。
内容会偏杂，偏多。
包括但不限于，

1.整句的回归和自造词的功能优化，
a 是整句    '是自造词   ''是删除自造词 例如   
ajlolki空格空格   ←整句 两次空格上屏
'dslz空格            ←添加自造词 （注意引号是单引号）
''dslz空格           ← 删除自造词  （注意是两个单引号）

2.英文字母的（i）功能临时使用
i + 字母  空格两下英文上屏   或回车一下英文上屏
例如  igood ted   空格两下，或 回车一下
